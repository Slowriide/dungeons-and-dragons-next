      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="space-y-2">
            <p className="text-sm font-manuscript italic text-ink leading-relaxed pl-3 border-l-2 border-gold/30">
        ...
        <div>
          ...
          <p className="text-sm font-manuscript italic text-ink leading-relaxed pl-3 border-l-2 border-burgundy/30">
            "{personality.ideal}"
          </p>
        </div>
        ...
        <div>
          <div className="flex items-center gap-2 text-xs font-fantasy uppercase tracking-wider text-muted-foreground mb-2">
            <Link className="w-3 h-3 text-brown" />
            Bonds
          </div>
          <p className="text-sm font-manuscript italic text-ink leading-relaxed pl-3 border-l-2 border-brown/30">
            "{personality.bond}"
          </p>
        </div>
