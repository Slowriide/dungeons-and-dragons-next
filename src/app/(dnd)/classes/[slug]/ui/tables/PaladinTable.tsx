...
export const PaladinTable = ({ levels }: Props) => {
  return (
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-center font-serif">Aura Range</TableHead>
          ...
          {levels.map((level) => (
            <TableRow key={level.index}>
              ...
              <TableCell className="text-center">
                {level.class_specific?.aura_range ? (
                  <p>{level.class_specific.aura_range} fts.</p>
                ) : (
                  <p>—</p>
                )}
              </TableCell>
